...
import { db } from '../../../db';
import { Gender, MembershipProduct } from '../../../types';
...
const MemberRegistrationModal: React.FC<MemberRegistrationModalProps> = ({ onClose, onSuccess }) => {
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[2000] flex items-center justify-center p-4 animate-in fade-in duration-200">
            <div className="bg-white rounded-[40px] shadow-2xl p-10 w-full max-w-lg border border-slate-100 relative overflow-hidden">
                ...
                <div className="flex justify-between items-center mb-8">
                    <div>
                        <h3 className="text-2xl font-bold text-[#2F3A32]">신규 회원 등록</h3>
                        <p className="text-[11px] text-[#A58E6F] font-bold uppercase tracking-widest mt-1">Quick Registration</p>
                    </div>
